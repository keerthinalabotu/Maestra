...
def preprocess_function(examples):
    print("Starting preprocess_function...")
    # Process audio
...
print("Dataset...")
print(librispeech[0])  # Print the first example
print("--------------")
print(librispeech.column_names)  # Print the column names

librispeech = librispeech.cast_column("audio", Audio(sampling_rate=16000))



dataset = librispeech.map(preprocess_function, remove_columns=librispeech.column_names, batched=True)
